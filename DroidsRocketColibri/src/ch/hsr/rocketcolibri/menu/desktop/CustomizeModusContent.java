...
public class CustomizeModusContent extends ModusContent{
	...
	protected void onCreate(List<WidgetEntry> widgetEntries) {
		...
		int width = RocketColibriDefaults.dpToPixelX(tContext.getResources().getDisplayMetrics(), 80);
		int height = RocketColibriDefaults.dpToPixelY(tContext.getResources().getDisplayMetrics(), 80);
