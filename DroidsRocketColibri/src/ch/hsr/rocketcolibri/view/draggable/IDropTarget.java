...
public interface IDropTarget {
     ...
     */
    boolean acceptDrop(IDragSource source, int x, int y, int xOffset, int yOffset,
            DragView dragView, Object dragInfo);
     ...
     */
    Rect estimateDropLocation(IDragSource source, int x, int y, int xOffset, int yOffset,
