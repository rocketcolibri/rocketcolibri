 ...
 * 
 */
public class SimpleObject extends Mesh {
	/**
	 ...
	 */
	public SimpleObject(float width, float height) {
		...
		float[] vertices = new float[] { -0.3f, -0.3f, 0.4f, 0.3f, -0.3f, 0.4f,
				-0.3f, 0.3f, 0.4f, 0.3f, 0.3f, 0.4f };

		setIndices(indices);
		setVertices(vertices);
		setTextureCoordinates(textureCoordinates);
		setColor(130.0f, 39.0f, 22.0f, 1.0f);
	}
}
